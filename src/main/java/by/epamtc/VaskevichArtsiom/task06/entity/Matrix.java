package by.epamtc.VaskevichArtsiom.task06.entity;
...
public class Matrix {
    ...
    private static final String N_VALUE = RESOURCE_BUNDLE.getString("value_n");
    ...
    private void writeMatrix(int[][] matrix, int x, int y) {
        ...
        stringBuffer.append(String.format("Row № %d sum is %d \n", x, sumOfRow(matrix, x)));
        stringBuffer.append(String.format("Column № %d sum is %d \n", y, sumOfColumn(matrix, y)));
        stringBuffer.append("\n");
    }
